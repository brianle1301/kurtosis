...
// GetUserServicesOutputAndExitCode provides a mock function with given fields: ctx, enclaveUuid, filters, timeout
func (_m *MockKurtosisBackend) GetUserServicesOutputAndExitCode(ctx context.Context, enclaveUuid enclave.EnclaveUUID, filters *service.ServiceFilters, timeout time.Duration) (map[service.ServiceUUID]*exec_result.ExecResult, map[service.ServiceUUID]error, error) {
	ret := _m.Called(ctx, enclaveUuid, filters, timeout)

	if len(ret) == 0 {
		panic("no return value specified for GetUserServicesOutputAndExitCode")
	}

	var r0 map[service.ServiceUUID]*exec_result.ExecResult
	var r1 map[service.ServiceUUID]error
	var r2 error
	if rf, ok := ret.Get(0).(func(context.Context, enclave.EnclaveUUID, *service.ServiceFilters, time.Duration) (map[service.ServiceUUID]*exec_result.ExecResult, map[service.ServiceUUID]error, error)); ok {
		return rf(ctx, enclaveUuid, filters, timeout)
	}
	if rf, ok := ret.Get(0).(func(context.Context, enclave.EnclaveUUID, *service.ServiceFilters, time.Duration) map[service.ServiceUUID]*exec_result.ExecResult); ok {
		r0 = rf(ctx, enclaveUuid, filters, timeout)
	} else {
		if ret.Get(0) != nil {
	...
	if rf, ok := ret.Get(1).(func(context.Context, enclave.EnclaveUUID, *service.ServiceFilters, time.Duration) map[service.ServiceUUID]error); ok {
		r1 = rf(ctx, enclaveUuid, filters, timeout)
	} else {
		if ret.Get(1) != nil {
			r1 = ret.Get(1).(map[service.ServiceUUID]error)
		}
	...
	if rf, ok := ret.Get(2).(func(context.Context, enclave.EnclaveUUID, *service.ServiceFilters, time.Duration) error); ok {
		r2 = rf(ctx, enclaveUuid, filters, timeout)
	} else {
		r2 = ret.Error(2)
	}
...
// MockKurtosisBackend_GetUserServicesOutputAndExitCode_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetUserServicesOutputAndExitCode'
type MockKurtosisBackend_GetUserServicesOutputAndExitCode_Call struct {
	*mock.Call
}

// GetUserServicesOutputAndExitCode is a helper method to define mock.On call
//   - ctx context.Context
//   - enclaveUuid enclave.EnclaveUUID
//   - filters *service.ServiceFilters
//   - timeout time.Duration
func (_e *MockKurtosisBackend_Expecter) GetUserServicesOutputAndExitCode(ctx interface{}, enclaveUuid interface{}, filters interface{}, timeout interface{}) *MockKurtosisBackend_GetUserServicesOutputAndExitCode_Call {
	return &MockKurtosisBackend_GetUserServicesOutputAndExitCode_Call{Call: _e.mock.On("GetUserServicesOutputAndExitCode", ctx, enclaveUuid, filters, timeout)}
}

func (_c *MockKurtosisBackend_GetUserServicesOutputAndExitCode_Call) Run(run func(ctx context.Context, enclaveUuid enclave.EnclaveUUID, filters *service.ServiceFilters, timeout time.Duration)) *MockKurtosisBackend_GetUserServicesOutputAndExitCode_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(enclave.EnclaveUUID), args[2].(*service.ServiceFilters), args[3].(time.Duration))
	})
	return _c
}

func (_c *MockKurtosisBackend_GetUserServicesOutputAndExitCode_Call) Return(successfulUserServiceExecResults map[service.ServiceUUID]*exec_result.ExecResult, erroredUserServiceUuids map[service.ServiceUUID]error, resultErr error) *MockKurtosisBackend_GetUserServicesOutputAndExitCode_Call {
	_c.Call.Return(successfulUserServiceExecResults, erroredUserServiceUuids, resultErr)
	return _c
}

func (_c *MockKurtosisBackend_GetUserServicesOutputAndExitCode_Call) RunAndReturn(run func(context.Context, enclave.EnclaveUUID, *service.ServiceFilters, time.Duration) (map[service.ServiceUUID]*exec_result.ExecResult, map[service.ServiceUUID]error, error)) *MockKurtosisBackend_GetUserServicesOutputAndExitCode_Call {
	_c.Call.Return(run)
	return _c
}
