...
func TestAddServiceShared_EntryPointArgsRuntimeValueAreReplaced(t *testing.T) {
	...
	serviceConfig, err := service.CreateServiceConfig(testContainerImageName, nil, nil, nil, nil, nil, []string{"-- " + runtimeValue}, nil, nil, nil, nil, 0, 0, "", 0, 0, map[string]string{}, nil, nil, map[string]string{}, image_download_mode.ImageDownloadMode_Missing, true, service.WorkloadTypeStatefulSet)
	require.NoError(t, err)
...
func TestAddServiceShared_CmdArgsRuntimeValueAreReplaced(t *testing.T) {
	...
	serviceName := service.ServiceName("example-datastore-server-2")
	serviceConfig, err := service.CreateServiceConfig(testContainerImageName, nil, nil, nil, nil, nil, nil, []string{"bash", "-c", "sleep " + runtimeValue}, nil, nil, nil, 0, 0, "", 0, 0, map[string]string{}, nil, nil, map[string]string{}, image_download_mode.ImageDownloadMode_Missing, true, service.WorkloadTypeStatefulSet)
	require.NoError(t, err)
...
func TestAddServiceShared_EnvVarsWithRuntimeValueAreReplaced(t *testing.T) {
	...
	serviceConfig, err := service.CreateServiceConfig(testContainerImageName, nil, nil, nil, nil, nil, nil, nil, map[string]string{
		"PORT": runtimeValue,
	}, nil, nil, 0, 0, "", 0, 0, map[string]string{}, nil, nil, map[string]string{}, image_download_mode.ImageDownloadMode_Missing, true, service.WorkloadTypeStatefulSet)
	require.NoError(t, err)
...
func TestAddServiceShared_ServiceNameWithRuntimeValuesAreReplaced(t *testing.T) {
	...
	serviceConfig, err := service.CreateServiceConfig(testContainerImageName, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, 0, 0, "", 0, 0, map[string]string{}, nil, nil, map[string]string{}, image_download_mode.ImageDownloadMode_Missing, true, service.WorkloadTypeStatefulSet)
	require.NoError(t, err)
